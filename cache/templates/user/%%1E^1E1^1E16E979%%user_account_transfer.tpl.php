<?php /* Smarty version 2.6.26, created on 2015-06-04 05:42:50
         compiled from user_account_transfer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'user_account_transfer.tpl', 46, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class ="col-md-6 col-sm-6 ui-sortable">
                                    <select class=" form-control" id="acc_id" name="acc_id">
                                        <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['acc_ids']), $this);?>
                            ...
                            <div class="form-group">
                                ...
                                <div class='col-md-6 col-sm-6 ui-sortable input-group'>
                                    <input type="text" class="form-control" id="trans_amount" name="trans_amount">
                                     ...
                                     <input type="hidden" id="acc_balance" data-balance = "<?php echo $this->_tpl_vars['acc_balance']; ?>
" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class ="col-md-6 col-sm-6 ui-sortable">
                                    <select class=" form-control" name="trans_acc_id" id="trans_acc_id">
                                        <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['trans_acc_ids']), $this);?>
            ...
            $('#commit').click(function(){
                ...
                $.ajax({
                    ...
                    success:function(data){
                       console.log(data);
                        if(data.flag === 1){
                            $('.modal-content').html("<h3>"+data.msg+"</h3>");
                             setTimeout(function(){
